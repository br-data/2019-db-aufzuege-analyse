...
db.elevators <- read_delim("../input/Open Data/DBSuS-Uebersicht_Aufzuege-Stand2018-11_V2.csv",
                           ";",
...
# elevators overview from DB
db.stations <- readr::read_delim("../input/Open Data/DBSuS-Uebersicht_Bahnhoefe-Stand2019-03.csv",
                                 ";",
                                 escape_double = FALSE,
                                 trim_ws = TRUE)
